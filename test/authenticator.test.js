...
describe('Authenticator', () => {
  ...
  describe('#deserializeUser', () => {
    ...
    describe('with one deserializer', () => {
      const authenticator = new Authenticator();
      authenticator.deserializeUser((obj, done) => {
  ...
  describe('#transformAuthInfo', () => {
    ...
    describe('with one transform', () => {
      const authenticator = new Authenticator();
      authenticator.transformAuthInfo((info, done) => {
    ...
    describe('with one sync transform', () => {
      const authenticator = new Authenticator();
      authenticator.transformAuthInfo(info => ({ clientId: info.clientId, client: { name: 'Foo' } }));
    ...
    describe('with one transform that takes request as argument', () => {
      ...
      authenticator.transformAuthInfo((req, info, done) => {
        if (req.url !== '/foo') { return done(new Error('incorrect req argument')); }
        return done(null, { clientId: info.clientId, client: { name: 'Foo' } });
      });
