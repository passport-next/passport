  ...
  serializeUser(fn, req, done) {
    ...
    return (async function pass(i, err, serializedUser) {
      ...
      try {
        ...
        if (isThenable(ret)) {
          return ret.then((serializedObject) => {
